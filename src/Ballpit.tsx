...
class x {
  ...
  dispose() {
    ...
    // Removed forceContextLoss to prevent issues in React Strict Mode where the same canvas is reused
...
const X = {
  count: 200,
  colors: [0x000000, 0x111111, 0x222222], // Adjusted default colors to be darker
